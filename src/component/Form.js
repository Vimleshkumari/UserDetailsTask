                ...
                <div className="col-md-4 offset-4">
                    ...
                    <form className="form" onSubmit={(e) => this.submitRegister(e)}>
                        ...
                        <div className="form-group">
                            ...
                            placeholder="Enter your name e.g: john@gmail.com" 
                            onChange={this.handleInputChange}
                            required/>
                        </div>
                        ...
                        <div>
                        <button type="submit" className="btn btn-success btn-block center" disabled={!formValid.button}>Submit</button><br/>
